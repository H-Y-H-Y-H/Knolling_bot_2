...
para_dict = {'device': 'cuda:0',
             ...
             'ratio': 0.8,
             'epoch': 300,
             'model_path': './results/MLP_907_3/',
             'input_data_path': '../../knolling_dataset/MLP_unstack_907_intensive/labels_box/',
             'output_data_path': '../../knolling_dataset/MLP_unstack_907_intensive/labels_unstack/',
