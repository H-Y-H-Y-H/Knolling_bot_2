...
class Unstack_env(Arm_env):
    ...
    def get_grasp_info(self, img_index_start, baseline_flag=False):
        ...
        crowded_index, prediction, model_output = self.grasp_model.pred_yolo(manipulator_before_input, new_lwh_list_input,
                                                                             pred_conf_input)
...
if __name__ == '__main__':
    ...
    para_dict = {'start_num': 204000, 'end_num': 224000, 'thread': 0,
                 ...
                 'dataset_path': '../../../knolling_dataset/MLP_unstack_906_intensive/',
                 'urdf_path': '../../urdf/',
