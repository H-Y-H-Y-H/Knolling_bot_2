        ...
        for i in range(len(rays)):
            ...
            if move_success_flag == True:
                ...
                if check_flag == False:
                    ...
                    manipulator_before_input, new_lwh_list_input, pred_conf_input, crowded_index, prediction, model_output = self.get_obs(epoch=self.img_per_epoch + img_index_start)
                    if self.para_dict['real_operate'] == False:
                        if len(manipulator_before_input) <= 1 or len(self.boxes_index) == 1:
                            print('no pile in the environment, try to reset!')
                            return self.img_per_epoch
...
if __name__ == '__main__':
    ...
    para_dict = {'start_num': 0, 'end_num': 10, 'thread': 0,
                 ...
                 'dataset_path': '../../../knolling_dataset/MLP_unstack_904/',
                 'urdf_path': '../../urdf/',
