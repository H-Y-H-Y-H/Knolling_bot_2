...
DATAROOT = "../../knolling_dataset/learning_data_1015/"
...
class Knolling_Transformer(nn.Module):
    ...
    def calculate_loss(self, pred_pos, tar_pos, tar_lw):
        ...
        MSE_loss = self.masked_MSE_distance_loss(pred_pos, tar_pos, ignore_index = -100)
        Distance_loss = self.calculate_distance(pred_pos=pred_pos_raw, tar_pos=tar_pos_raw, tar_lw=tar_lw_raw)

        total_loss = MSE_loss + Distance_loss

        return total_loss

    def masked_MSE_distance_loss(self, pred_pos, tar_pos, ignore_index=-100):
    ...
    def calculate_distance(self, pred_pos, tar_pos, tar_lw):
        ...
        tar_pos_edge = torch.cat((tar_pos_x_low, tar_pos_x_high, tar_pos_y_low, tar_pos_y_high), 2)
