...
class Arm:
    ...
    def step(self, evaluation):
        ...
        if self.real_operate == True:
            ...
            # with open(file="../../knolling_dataset/nn_data_xyz/cmd_xyz_nn.csv", mode="w", encoding="utf-8") as f:
            #     f.truncate(0)
            # with open(file="../../knolling_dataset/nn_data_xyz/real_xyz_nn.csv", mode="w", encoding="utf-8") as f:
            #     f.truncate(0)
            # with open(file="../../knolling_dataset/nn_data_xyz/cmd_nn.csv", mode="w", encoding="utf-8") as f:
            #     f.truncate(0)
            # with open(file="../../knolling_dataset/nn_data_xyz/real_nn.csv", mode   ="w", encoding="utf-8") as f:
            #     f.truncate(0)
            # with open(file="../../knolling_dataset/step.txt", mode="w", encoding="utf-8") as f:
            #     f.truncate(0)
