...
if __name__ == '__main__':
    ...
    print("device:", device)
    PROJECT_PATH = "C:/Users/yuhan/PycharmProjects/Knolling_bot_2/"
    para_dict = {'start_num': 00, 'end_num': 10000, 'thread': 0,
                 'yolo_conf': 0.6, 'yolo_iou': 0.8, 'device': 'cuda',
                 'save_img_flag': True,
                 ...
                 'urdf_path': PROJECT_PATH+ '/urdf/',
                 'yolo_model_path':PROJECT_PATH+ '/train_pile_overlap_627/weights/best.pt'}
