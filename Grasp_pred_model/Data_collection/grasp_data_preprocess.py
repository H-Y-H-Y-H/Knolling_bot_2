...
if __name__ == '__main__':
    ...
    # data_path = data_root + 'grasp_pile_712_lab_add/'
    # # data_path = data_root + 'origin_labels_713_lab/'
    #
    # target_data_path = data_root + 'grasp_pile_712_lab_add/'
    # # target_data_path = data_root + 'origin_labels_713_lab/'
    #
    # data_num = 480000
    # start_index = 1200000
    # target_start_index = 1200000
    ...
    source_path = '/home/ubuntu/Desktop/knolling_dataset/grasp_pile_712_lab_add/labels/'

    # target_path = '/home/zhizhuo/Creative_Machines_Lab/knolling_dataset/grasp_dataset_713/labels/'
    target_path = '/home/ubuntu/Desktop/knolling_dataset/grasp_dataset_714/labels/'
    os.makedirs(target_path, exist_ok=True)
    source_start_index = 1200000
    target_start_index = 1650000
    num = 480000
