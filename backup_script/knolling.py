...
class knolling_main:
    ...
    def get_parameters(self, knolling_env, evaluations=None, knolling_generate_parameters=None, use_knolling_model=None, reset_pos=None, reset_ori=None,
                       dynamic_parameters=None, general_parameters=None):

        self.evaluations = evaluations
        self.knolling_generate_parameters = knolling_generate_parameters
        self.dynamic_parameters = dynamic_parameters
        self.general_parameters = general_parameters
        self.use_knolling_model = use_knolling_model
        self.knolling_env = knolling_env
    ...
    def step(self):
        ...
        self.knolling_env.get_env_parameters(manual_knolling_parameters=self.knolling_generate_parameters,
                                             evaluations=self.evaluations,
                                             general_parameters=self.general_parameters,
                                             dynamic_parameters=self.dynamic_parameters)
        self.grasp_lstm = grasp_model()
...
if __name__ == '__main__':
    ...
    for evaluation in range(general_parameters['evaluations']):
        knolling_generate_parameters = {'total_offset': [0.035, -0.17 + 0.016, 0], 'gap_item': 0.015, 'gap_block': 0.015, 'random_offset': False,
                                        'area_num': 2, 'ratio_num': 1,
                                        'boxes_num': np.random.randint(10, 11), 'reset_style': 'pile', 'order_flag': 'confidence',
