...
class yolo_grasp_collection_env():
    ...
    def __init__(self, para_dict, knolling_para=None):
        ...
        if self.para_dict['use_yolo_grasp_model'] == True:
            self.yolo_grasp_model = Yolo_grasp_model(para_dict=para_dict)
    ...
    def get_obs(self, epoch=0, look_flag=False, baseline_flag=False, sub_index=0, img_path=None):
        ...
        if look_flag == True:
            ...
            if self.para_dict['real_operate'] == False:
                ...
                if self.para_dict['use_yolo_grasp_model'] == True:
                    manipulator_before, new_lwh_list, pred_cls, pred_conf = self.yolo_grasp_model.grasp_predict(img=img, epoch=epoch, first_flag=baseline_flag)
